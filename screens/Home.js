...
const Home = ({navigation}) => {
  const bookOtherWordsForHome = {
    id: 1,
    bookName: 'Ohter Words For Home',
    bookCover: images.a_image,
    rating: 4.5,
    language: 'Eng',
    pageNo: 341,
  ...
  const bookTheMetropolis = {
    id: 2,
    bookName: 'TheMetropolis',
    bookCover: images.b_image,
    rating: 4.5,
    language: 'Kor',
    pageNo: 341,
    author: 'Jasmine Warga',
  ...
  const bookTheTinyDragon = {
    id: 3,
    bookName: 'TheTinyDragon',
    bookCover: images.c_image,
    rating: 4.5,
    language: 'Eng',
    pageNo: 341,
    author: 'Jasmine Warga',
